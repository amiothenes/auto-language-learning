...
function StatsCardSkeleton() {
  return (
    <div className="space-y-6">
      ...
      {/* Stats Skeleton — compact grid on mobile, rows on xl+ */}
      <Card variant="default" padding="sm" className="p-0! overflow-hidden">

        {/* MOBILE skeleton: 3-col grid */}
...
export function StatsCard({ isLoading: isLoadingProp = false }: StatsCardProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Stats — compact 3-col grid on mobile, icon rows on xl+ */}
      <Card variant="default" padding="sm" className="p-0! overflow-hidden">
        ...
        <div className="grid grid-cols-3 divide-x divide-border xl:hidden">
          ...
          <div className="py-3 px-2 flex flex-col items-center gap-0.5 text-center">
            ...
            <Muted size="xs">Day Streak</Muted>
          </div>
        </div>

        {/* DESKTOP xl+: icon rows */}
        <div className="hidden xl:block divide-y divide-border">
          ...
          <div className="p-4 flex items-center gap-4">
            ...
            <div className="flex-1 min-w-0">
              <Muted size="xs" className="mb-0.5">Day Streak</Muted>
